...
from .visuals.histos import MultiHistogram, Histogram, StreamingMultiHistogram, VariableGranularityHistogram, BinSpec
...
__all__ = ["LineGraph", "MergedLineGraph",
           ...
           "MultiHistogram", "Histogram", "StreamingMultiHistogram", "VariableGranularityHistogram", "BinSpec",
           "Table", "ColumnStyle",
